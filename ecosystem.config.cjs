...
module.exports = {
  apps: [
    ...
    },
    {
      ...
      cwd: '/home/dovanlong/g.bookedai.au',
      env: {
        APP_DIR: 'apps/web-longcare',
        PORT: 3001,
        NODE_ENV: 'production',
        NEXT_PUBLIC_GA4_ID: dotenv.GA4_MEASUREMENT_ID || '',
        NEXT_PUBLIC_GTM_ID: dotenv.GTM_ID || '',
        NEXT_PUBLIC_SITE_URL: 'https://longcare.au',
        NEXT_PUBLIC_CONTACT_EMAIL: dotenv.CONTACT_EMAIL || 'hello@longcare.au',
        NEXT_PUBLIC_SOCIAL_PROOF: 'false',
        API_URL: dotenv.API_URL || 'http://localhost:8090',
        ALLOWED_ORIGINS: 'https://longcare.au,https://book.longcare.au,https://app.longcare.au,https://admin.longcare.au,https://g.longcare.au',
      },
    },
    {
      name: 'booking',
