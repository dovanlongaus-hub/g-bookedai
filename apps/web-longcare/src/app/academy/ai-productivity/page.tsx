...
export const metadata: Metadata = getPageMetadata({
  title: 'AI Productivity — Save 10+ Hours/Week | LongCare Academy',
  description:
    'AI productivity course for working professionals. Master email, docs, meetings, spreadsheets, and research AI in 8 lessons over 4 hours.',
  path: '/academy/ai-productivity',
});

const lessons = [
  { id: 1, title: 'Email AI: Gemini, Superhuman, and triage workflows', duration: '30 min' },
  { id: 2, title: 'Document AI: drafts, summaries, and rewrites', duration: '30 min' },
  { id: 3, title: 'Meeting AI: notes, action items, and follow-ups', duration: '30 min' },
  { id: 4, title: 'Spreadsheet AI: formulas, analysis, and clean-up', duration: '30 min' },
  { id: 5, title: 'Search AI: Perplexity and deep research workflows', duration: '30 min' },
  { id: 6, title: 'Code AI for non-coders: small scripts and macros', duration: '30 min' },
  { id: 7, title: 'AI for travel, planning, and life admin', duration: '20 min' },
  { id: 8, title: 'Build your personal AI stack + capstone', duration: '20 min' },
];

const learnings = [
  'Process inbox 2x faster with AI triage and templated replies',
  'Turn long meetings into clean notes and action items automatically',
  'Cut research time by 60% with deep research workflows',
  'Generate spreadsheet formulas and clean data without scripts',
  'Build a personal AI stack tailored to your role',
  'Save a measurable 10+ hours per week on routine knowledge work',
];
...
const courseSchema = {
  ...
  '@type': 'Course',
  name: 'AI Productivity — Save 10+ Hours/Week',
  description:
    'Productivity-focused AI course for working professionals covering email, docs, meetings, spreadsheets, search, and code AI.',
  provider: {
    '@type': 'Organization',
    name: 'LongCare AU',
          ...
          <div>
            <div className="flex items-center gap-2 mb-4 flex-wrap">
              <Badge variant="outline" className="border-emerald-200 bg-emerald-50 text-emerald-700">
                <Zap className="size-3" /> Professionals
              </Badge>
            ...
            <p className="mt-4 text-lg text-slate-600 max-w-2xl">
              Save 10+ hours every week. Master AI for email, docs, meetings, spreadsheets,
              and research — and build a personal AI stack you actually keep using.
            </p>
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-600">
              First lesson is free. Full course <strong>A$59</strong> — or included with
              any Mentor 5-pack.
            </p>
          </div>
          <div className="flex flex-wrap gap-3">
            <a
              href="https://book.longcare.au?service=academy-ai-productivity"
              className="inline-flex items-center gap-2 bg-sky-700 hover:bg-sky-800 text-white font-medium px-5 py-2.5 rounded-lg transition"
            >
