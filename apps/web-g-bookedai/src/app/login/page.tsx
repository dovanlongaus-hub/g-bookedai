...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-white to-[#f0fdfa]">
      <div className="w-full max-w-md p-8 bg-white rounded-2xl shadow-xl border border-gray-100">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[#0f2942] mt-2 text-sm font-medium">
        ...
        <div className="space-y-4">
          ...
          {!firebaseError && (
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors font-medium text-[#0f2942]"
            >
          ...
          {(providers.openai || firebaseError) && (
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-[#0f2942] hover:bg-[#1a3a5c] text-white rounded-xl transition-colors font-medium"
            >
        ...
        <p className="text-center text-xs text-[#0d9488] mt-2 font-medium">
          bookedai.au
        </p>
      </div>
    </div>
